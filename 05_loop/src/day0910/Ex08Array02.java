...
public class Ex08Array02 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("배열의 크기 : "+array.length); //array.length = SIZE 로 해도됨
		
		//배열의 전체를 한번씩 찍어보자
		//배열의 각 위치는 우리가 index를 통해서 접근하기때문에
		//for 문을 이용해 줄수 있다!
		for(int i = 0; i < array.length; i++) {
			System.out.println(i+"네번째의 값: "+array[i]);
		}
