...
public class Ex01ArrayList {
	public static void main(String[] args) {
		...
		System.out.println("carList.get(2): "+carList.get(2));
		carList.remove(c44);
		System.out.println("carList.size(): "+carList.size());
		carList.remove(c55);
		System.out.println("carList.size(): "+carList.size());
		...
		// 5. carList에서 해당 객체의 index가 궁금하다면 indexOf() 메소드를 실행하면 된다.
		...
		System.out.println("carList.indexOf(c2): "+carList.contains(c2));
		System.out.println("carList.indexOf(c4): "+carList.contains(c4));
		
		// 따라서, ArrayList를 제대로 사용하고 싶다면,
		// 우리가 < > 에 넣어줄 클래스에
		// equals()를 정확하게 만들어주는 것이 중요하다!!!!
	}
}
